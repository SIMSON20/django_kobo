        ...
        migrations.RunSQL(
            ...
            CREATE OR REPLACE VIEW bns_ame_per_hh AS
             SELECT row_number() OVER () AS id,
              ...
              GROUP BY k.dataset_owner, d.hh_id, k.dataset_year, d.village, d.district, d.landscape;
        ...
        migrations.RunSQL(
            ...
            CREATE OR REPLACE VIEW bns_ame_per_village AS 
             SELECT row_number() OVER () AS id,
              ...
              GROUP BY a.dataset_owner, a.dataset_year, a.village, a.district, a.landscape;
        ...
        migrations.RunSQL(
            ...
            CREATE OR REPLACE VIEW bns_ame_per_district AS 
             SELECT row_number() OVER () AS id,
                ...
                count(a.hh_id) AS n
               FROM bns_ame_per_hh a
              GROUP BY a.dataset_owner, a.dataset_year, a.district, a.landscape;
        ...
        migrations.RunSQL(
            ...
            CREATE OR REPLACE VIEW bns_ame_per_landscape AS 
             SELECT row_number() OVER () AS id,
                ...
                count(a.hh_id) AS n
               FROM bns_ame_per_hh a
              GROUP BY a.dataset_owner, a.dataset_year, a.landscape;
